      ...
      <main className="flex-1 p-6 flex gap-6">
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            <label className="border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground
              hover:bg-primary/5" 
              htmlFor="video">
                <FileVideo className="w-4 h-4"/>
                Selecione vídeo</label>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">
                Valores mais alatos tendem a deixar o resultado mais criativo e com possíveis erros.
              </span>
            </div>
